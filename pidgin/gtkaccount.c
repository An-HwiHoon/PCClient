...
/*//httpjson
    char* jsondata;//json 받아오는 변수
    char* url = "27.1.48.149/api/login.do";
    char id[33];
    char pass[33];
    char para[112]="id=";
    struct jsonstr re;//구조체

    strcpy(id,"6cf4d67bb26d86fa3977d9648d41ae61");//암호화된 ID 넣으면 됨
    strcpy(pass, "a8c920a5c15be54af238aff5e5f21805");//암호화된 패스워드 넣으면됨
...
/*//httpjson
	if(re.code == 100)
	{
		purple_debug_warning("anhh", "[%s:%d(%s)] @debug 접속성공!!!!!!!! \n", __FILE__, __LINE__, __func__);
